...
const fakey = (teks) => {
mans.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `Join Jadi Wibu 😎`,"body": `Join Bot's Official GC`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./plugins/gambar/neobotz.jpg`),"sourceUrl": "https://chat.whatsapp.com/G3ydGzHeZ825IU4RjLuToY"}}}, { quoted: m})
}
const ftextt = {
key: { 
fromMe: false,
